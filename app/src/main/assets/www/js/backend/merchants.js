...
const VENDORS = {
  ...
  'Transport & Fuel': [
    ...
    'petrol pump', 'diesel', 'fuel', 'fuel station', 'petroleum', 'filling station',
    ...
    'motors', 'tyre', 'tyres', 'puncture', 'lubricants', 'engine oil', 'spare parts',
    'driving school', 'rto',
  ],
  Travel: [
  ...
  Shopping: [
    ...
    'pet shop', 'pet store', 'pet supplies', 'toys', 'toy store', 'watches',
    'gyftr', 'smartbuy', 'qwikcilver', 'woohoo',
  ],
  Entertainment: [
    'bookmyshow', 'ticketnew', 'paytm insider', 'pvr', 'inox', 'pvr inox', 'cinepolis',
    'carnival cinema', 'imax', 'netflix', 'amazon prime', 'prime video', 'hotstar',
    'jiohotstar', 'disney', 'sonyliv', 'sony liv', 'zee5', 'jiocinema', 'voot', 'mubi',
    'lionsgate play', 'apple tv', 'crunchyroll', 'discovery plus', 'erosnow', 'shemaroo',
    'spotify', 'gaana', 'wynk', 'saavn', 'jiosaavn', 'apple music', 'amazon music',
    'youtube', 'youtube premium', 'youtube music', 'apple media', 'audible', 'kindle',
  ...
  Health: [
    ...
    'wellness forever', 'truemeds', 'zeno health', 'practo', 'mfine', 'cult fit',
    'cultfit', 'healthify', 'pristyn care', 'clove dental', 'sabka dentist', 'cloudnine',
    ...
    'health', 'healthcare', 'pharmacy', 'pharma', 'chemist', 'chemists', 'druggist',
    ...
    'physiotherapy', 'therapy', 'counselling', 'psychiatry', 'psychologist',
    ...
    'vaccine', 'vaccination', 'immunisation', 'ambulance', 'orthopedic', 'surgery',
    'surgical', 'veterinary', 'vet clinic', 'pet clinic',
  ],
  'Personal Care': [
    ...
    'kaya skin', 'vlcc', 'enrich', 'bodycraft', 'golds gym', 'gold gym', 'fitness first',
    ...
    'tattoo', 'piercing', 'massage', 'aesthetics', 'gym', 'fitness', 'yoga', 'zumba',
    'crossfit', 'pilates', 'aerobics', 'wellness', 'laundry', 'dry cleaner',
    'dry cleaning', 'ironing',
  ],
  Education: [
    'byju', 'unacademy', 'vedantu', 'physics wallah', 'toppr', 'whitehat', 'cuemath',
    'extramarks', 'testbook', 'adda247', 'oliveboard', 'aakash', 'allen career',
    'fiitjee', 'kumon', 'eurokids', 'kidzee', 'coursera', 'udemy', 'edx', 'skillshare',
    'khan academy', 'pluralsight', 'datacamp', 'codecademy', 'chegg', 'upgrad',
    'simplilearn', 'great learning', 'scaler', 'newton school', 'masai school',
    'linkedin learning',
    'school fee', 'school fees', 'college fee', 'college fees', 'hostel fee',
    'course fee', 'exam fee', 'exam fees', 'entrance exam', 'tuition', 'tuition fee',
    'tutorial', 'tutorials', 'tutor', 'coaching', 'classes', 'training institute',
    'certification', 'seminar', 'academy', 'institute', 'university',
    'polytechnic', 'junior college', 'vidyalaya', 'vidhyalaya', 'shiksha', 'gurukul',
    'playschool', 'play school', 'preschool', 'pre school', 'kindergarten', 'montessori',
    'admission', 'library', 'stationery', 'stationers', 'textbook', 'textbooks',
    'edutech', 'edtech', 'elearning', 'e learning',
  ],
  'Investment Outflow': [
