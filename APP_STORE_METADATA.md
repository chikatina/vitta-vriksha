...
## 3. ASO Keywords & Search Tags

```
personal finance, net worth tracker, mutual fund portfolio, CAS reader, expense tracker, SMS expense tracker, FIRE calculator, loan prepayment, offline budget, privacy first, wealth tracker, CAMS statement, KFintech statement, SIP tracker, debt payoff
```

---

## 4. Screenshot Structure (Pure HTML/CSS Mockups in `/site/vitta-vriksha/store-assets.html`)
